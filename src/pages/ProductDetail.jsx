                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-gray-900/40 backdrop-blur-sm animate-fadeIn">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-6 sm:p-8 overflow-y-auto">
                            <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); setIsQuoteModalOpen(false); alert('Quotation request submitted successfully!'); }}>
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Product Interest</label>
                                    <input type="text" readOnly value={`${product.name} - ${activeVariant.type}`} className="w-full bg-gray-50 border border-gray-200 text-gray-600 text-sm rounded-xl px-4 py-3 focus:outline-none" />
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Full Name</label>
                                        <input type="text" required placeholder="John Doe" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-[#0072bc] focus:ring-2 focus:ring-[#0072bc]/20 outline-none transition-all" />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Phone Number</label>
                                        <input type="tel" required placeholder="+91 XXXXX XXXXX" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-[#0072bc] focus:ring-2 focus:ring-[#0072bc]/20 outline-none transition-all" />
                                    </div>
                                </div>
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Email Address</label>
                                    <input type="email" required placeholder="john@company.com" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-[#0072bc] focus:ring-2 focus:ring-[#0072bc]/20 outline-none transition-all" />
                                </div>
                                <div>
                                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Project Details</label>
                                    <textarea rows="3" placeholder="Tell us about your requirement (e.g., Residential, Office space area)" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-[#0072bc] focus:ring-2 focus:ring-[#0072bc]/20 outline-none transition-all resize-none"></textarea>
                                </div>
                                <div className="mt-8 pt-2">
                                    <button type="submit" className="w-full py-4 bg-[#0072bc] text-white rounded-xl text-sm font-bold uppercase tracking-wider hover:bg-[#002f54] hover:shadow-lg hover:shadow-blue-500/20 transition-all active:scale-[0.98]">
                                        Submit Request
                                    </button>
                                </div>
                            </form>
