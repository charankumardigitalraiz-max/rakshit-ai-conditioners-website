        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-7 items-center">
            ...
            <div className="relative hidden lg:block">
              <div className="max-w-md ml-auto aspect-[4/5] rounded-[3rem] overflow-hidden border border-gray-100 relative bg-gray-100">
                <img src="/banner/hero_ac_interior_1776336133282.png" className="w-full h-full object-cover" alt="Corporate Environment" />
